            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                  ...
                  <h3 className="text-xl font-bold text-white">BNB Testnet Payment Required</h3>
                </div>
                <div className="bg-mintellect-primary/20 px-3 py-1.5 rounded-full flex items-center border border-mintellect-primary/30">
                  ...
                  <span className="font-mono text-white">{user?.credits || 0} BNB</span>
                </div>
              </div>
              ...
              <div className="flex items-center mb-6">
                ...
                <div className="px-4 py-1 bg-mintellect-primary/20 rounded-full text-sm font-medium border border-mintellect-primary/30">
                  Cost: {PLAGIARISM_REDUCTION_COST} BNB Tokens
                </div>
                <div className="flex-1 h-px bg-gray-700"></div>
              </div>
                ...
                >
                  {processingPayment ? (
                    ...
                    <>
                      ...
                      Pay {PLAGIARISM_REDUCTION_COST} BNB Tokens
                    </>
                  )}
                </RippleButton>
              </div>
      ...
      return (
        ...
        >
          ...
          <div className="flex-1">
            <p>
              Insufficient BNB tokens. You need {PLAGIARISM_REDUCTION_COST} tokens but only have {user?.credits || 0}.
            </p>
                    ...
                    <div className="p-4 border-t border-gray-700 flex justify-between items-center">
                      {paymentStep === null ? (
                        ...
                        <div className="flex items-center text-gray-400 text-sm">
                          ...
                          <span>Complete BNB Token Payment to Access</span>
                        </div>
                      )}
