  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        <meta property="og:description" content="Verify, improve, and certify your academic work with Mintiq's AI-powered platform." />
        <meta property="og:image" content="/images/Mintiq_logo.png" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Mintiq - AI-Powered Academic Integrity Platform" />
        <meta name="twitter:description" content="Verify, improve, and certify your academic work with Mintiq's AI-powered platform." />
        <meta name="twitter:image" content="/images/Mintiq_logo.png" />
      </head>
