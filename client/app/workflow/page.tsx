              ...
              <div
                ...
                style={{
                  width: `${(step / (steps.length - 1)) * 100}%`,
                      maxWidth: '100%',
                  background: '#3D0066', // Subtle dark purple
                  boxShadow: '0 0 8px 2px rgba(61,0,102,0.3)', // Subtle dark purple glow
                }}
              >
                ...
                {steps.map((s, i) => (
                  <div key={i} className="flex flex-col items-center group">
                    ...
                    <motion.div
                      ...
                      className={`relative w-12 h-12 rounded-full flex items-center justify-center z-10 transition-all duration-500
                        ${i < step
                          ? "bg-black border-2 border-[#8B5CF6] text-white shadow-[0_0_8px_2px_rgba(139,92,246,0.5)]"
                          : i === step
                            ? "bg-black border-2 border-[#8B5CF6] text-white group-hover:shadow-[0_0_16px_4px_rgba(139,92,246,0.7)]"
                            : "bg-black border-2 border-gray-700 text-gray-400"}
                        group-hover:shadow-[0_0_16px_4px_rgba(139,92,246,0.7)]`}
